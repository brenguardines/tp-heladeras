package ar.solicitarAperturaTest;
...
public class SolicitarAperturaTest {
  /*
      @Test
    public void solicitarAperturaHeladera() throws MqttException, TarjetaSinPermisoException, ElementoNoExisteEnRepositorioException {
       PersonaHumana persona = new PersonaHumana();
       persona.agregarTarjeta(new TarjetaColaborador());
       persona.getTarjetaColaborador().setEstaEnUso(true);
       persona.solicitarAperturaHeladera((long) 3, "Donar");
    }
   */
